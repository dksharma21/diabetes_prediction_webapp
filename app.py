...
with col2:
    ...
    bmi = st.text_input(label='BMI (0-100)')

    hba1c_level = st.text_input(label='HbA1c - Hemoglobin Level (0-9) ')

    blood_glucose_level = st.text_input(label='Blood Glucose Level (80-200)')
